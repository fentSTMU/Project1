...
public class Bank {
	...
	/*
	 * Method wasn't opening a new account, it was getting the value for the accountid given
	 * Instead of accountlit.get(), we used accountlist.put() and created a new account.
	 * Since the accountids that you listed in the test class were names, we assumed that
	 * all ID's would be names, so we used that as the name for the account.
	 */
	...
	/*
	 * Error found
	 * The method was using account.deposit instead of account.withdraw
	 */
